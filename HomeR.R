...
# Consider: https://rdrr.io/cran/lessR/man/to.html
### ### Creates Tibbles ### ###
...
for (BookNum in c(1:24)) {
  ...
  ### Read Book ###
  assign( # Assigns the variable Textₙ
  ...
  # Tibbles the variable Textₙ as Tibbleₙ
  # As it stands, however, the observances are all replaced with "Textₙ"
  # `to()` doesn't fix the problem, either. (Though the code somewhat neater this way)
  # GET RETURNS CHARACTERS IN A USABLE FORMAT
